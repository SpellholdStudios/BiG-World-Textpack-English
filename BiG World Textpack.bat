...
SET MAIN_DIR=BiG World Textpack ENGLISH
...
IF NOT EXIST "%MAIN_DIR%" (
    ...
    echo.
    echo.
    echo The directory "%MAIN_DIR%" could not be found.
    echo It is absolutely necessary for the installation
    echo and must be present in the current directory.
    echo.
    pause
    exit /B 1
)
